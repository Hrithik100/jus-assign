...
import React from "react";
import { PiBugBeetle, PiUser, PiX } from "react-icons/pi";
import { RiSignalTowerLine } from "react-icons/ri";

const Notification = ({ mobile, onClose }) => {
  const notifications = [
    {
      id: 1,
      text: "You have a bug that needs...",
  ...
  return (
    <div className="h-full bg-white border-l border-gray-200 dark:bg-black dark:border-neutral-800 overflow-y-auto">
      <div className="p-4 sm:p-6">
        ...
        <div className="space-y-3">
          {contacts.map((contact) => (
            <div key={contact.id} className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-sm flex-shrink-0">
                <PiUser />
              </div>
